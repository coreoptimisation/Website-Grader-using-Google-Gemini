...
>(({ className, showIcon = false, ...props }, ref) => (
  ...
  >
    {showIcon && (
      <div className="flex aspect-square w-4 h-4 rounded-sm bg-sidebar-primary/20 animate-pulse" />
    )}
    <div className="h-4 flex-1 max-w-[--skeleton-width] bg-sidebar-primary/20 rounded-sm animate-pulse" />
  </div>
))
